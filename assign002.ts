...
const sub1 = require("prompt-sync")()("Enter your Sub 1 marks: ");
const sub2 = require("prompt-sync")()("Enter your Sub 2 marks: ");
const sub3 = require("prompt-sync")()("Enter your Sub 3 marks: ");
const sub4 = require("prompt-sync")()("Enter your Sub 4 marks: ");


let totalMarks: number = 400;
let sum: number = Number(sub1)+Number(sub2)+Number(sub3)+Number(sub4);
let percent: number = Number((sum/totalMarks)*100);
